...
tests_all_require = tests_base_require + serpyco_require + marshmallow_require + tests_cov_require
dev_require = ["requests"] + tests_base_require + marshmallow_require + serpyco_require
